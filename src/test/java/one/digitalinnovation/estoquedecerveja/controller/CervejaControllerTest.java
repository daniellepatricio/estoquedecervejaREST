...
import static one.digitalinnovation.estoquedecerveja.utils.JsonConvertionUtils.asJsonString;
...
public class CervejaControllerTest {
    ...
    void whenGETIsCalledWithoutRegisteredNameThenNotFoundStatusIsReturned() throws Exception {
        ...
        //when
        when(beerService.findByName(beerDTO.getName())).thenThrow(CervejaNotFoundException.class);
